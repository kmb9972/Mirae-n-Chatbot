...
st.markdown("""
    ...
    /* 카테고리 그리드 */
    /* 카테고리 버튼 이미지 적용 */
    div[data-testid="stButton"]:has(> button[key="cat_new"]) > button,
    div[data-testid="stButton"]:has(> button[key="cat_attendance"]) > button,
    div[data-testid="stButton"]:has(> button[key="cat_leave"]) > button,
    div[data-testid="stButton"]:has(> button[key="cat_growth"]) > button,
    div[data-testid="stButton"]:has(> button[key="cat_office"]) > button,
    div[data-testid="stButton"]:has(> button[key="cat_culture"]) > button {
    ...
    div[data-testid="stButton"]:has(> button[key="cat_new"]) > button p,
    div[data-testid="stButton"]:has(> button[key="cat_attendance"]) > button p,
    div[data-testid="stButton"]:has(> button[key="cat_leave"]) > button p,
    div[data-testid="stButton"]:has(> button[key="cat_growth"]) > button p,
    div[data-testid="stButton"]:has(> button[key="cat_office"]) > button p,
    div[data-testid="stButton"]:has(> button[key="cat_culture"]) > button p {
        color: #111111 !important;
    }
