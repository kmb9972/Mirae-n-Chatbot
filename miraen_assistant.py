...
def get_mock_response(messages_history: list) -> str:
    ...
    if any(k in q for k in ("인사제도", "인사 제도", "인사 알려줘", "인사 뭐있어", "인사제도 뭐", "인사")):
        ...
        return (
            "🎖️ **인사제도 한눈에 보기**\n\n"
            "🏅 호칭 · 님(2년) → 선임(6년) → 책임(5년) → 수석\n"
            "📊 성과평가 · OKR 기반 · 연 **1회**\n"
            "📊 역량평가 · 공통 **50%** + 직군별 **50%** · 연 **1회**\n"
            "🏠 재택근무 · 주 **2회** 원칙 · 공휴일 2일↑ 포함 주는 불가\n"
            "⏰ 자율출근 · 일 **9시간** 준수 · 지각 없음\n"
            "📅 시프티(Shiftee) · 휴가입력 · 연장근무 신청\n\n"
    ...
    if any(k in q for k in ("복지제도", "복지 제도", "복지 알려줘", "복지 뭐있어", "복지제도 뭐", "복리후생", "복지")):
        ...
        return (
            "🎁 **복지제도 한눈에 보기**\n\n"
            "💰 복지포인트 · 연 **60만 원** · 베네피아 · 12/30 소멸\n"
            "👶 보육료 · 국가+회사 매칭 · 만 0~6세\n"
            "🎒 입학선물 · 초등 **30만** / 중고등 **40만** · 매년 2월 신청\n"
            "🎓 학자금 · 재직 **5년↑** 자녀 · 연 최대 **200만 원** · 8~9월 신청\n"
            "🌸 춘계휴가 · 3/30~4/3 **(5일)**\n"
            "📅 공동연차 · 연 **12일** · 1/30, 3/3, 4/24, 5/4, 6/19, 7/17, 8/14, 10/6~8, 11/20, 12/24\n"
            "🏖️ 플러스휴가 · 연 **4일** 추가 · 당해 소멸\n"
            "🏝️ 워케이션 · 제주 **1주일** · 숙박+항공 **50만 원** · 연 1회\n"
            "🏥 건강검진 · 입사 2년↑ · 격년 · 당일 **0.5일 공가**\n"
            "💐 경조사 · 결혼 **30만/7일** · 출산 **500만/20일** · 부모상 **30만/5일**\n\n"
    ...
    if any(k in q for k in ("일반안내", "일반 안내", "안내", "규정 알려줘", "결재규정", "사내 규정")):
        ...
        return (
            "📑 **기타 한눈에 보기**\n\n"
            "✅ 경비전표 · **100만↓** 팀장 / **2천만↓** 본부장 / 이상 사장\n"
            "✅ 구매품의 · **100만↓** 팀장 / **2천만↑** 사장\n"
            "✅ 접대비 · **20만↓** 팀장 / **30만↑** 본부장\n"
            "✈️ 출장 · 국내(팀원) 팀장 / 국내(팀장↑) 본부장 / 해외 사장\n"
            "📚 사외교육 · 그룹웨어 교육신청서 → 법인카드 선결제 → 25일 이후 정산\n"
            "💻 사이버연수원 · 매월 중순 전사게시판 신청 · 익월 수강 · 미수료 시 **6개월** 제한\n"
            "🏆 자격증 · LV1~5 학습비+축하금 **20~150만 원**\n"
            "🔒 문서보안 · doc.mirae-n.com · 포트 443 · 계정 사번\n"
            "📶 WIFI · 직원 MiraeN-AP / 방문객 MiraeN-WIfI\n"
            "🖥️ 그룹웨어 · gw.mirae-n.com · 전자결재·휴가·경조사 신고\n"
            "🪪 명함신청 · mirae-n.onehp.co.kr · ID: miraen / PW: 1111\n\n" "🪪 명함신청 · mirae-n.onehp.co.kr · ID: miraen / PW: 1111\n\n"
