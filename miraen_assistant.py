...
st.markdown("""
    ...
    div[data-testid="stButton"]:has(> button[key*="cat_"]) > button {
...
# HTML 버튼 렌더링
_cat_url = 'data:image/png;base64,'
_rows = []
_rows.append('<style>')
_rows.append('.cat-html-grid{display:grid;grid-template-columns:repeat(3,1fr);gap:8px;margin-bottom:16px}')
_rows.append('.cat-html-btn{width:100%;height:50px;border:none;border-radius:12px;cursor:pointer;'
    'background-size:cover;background-position:center;background-color:transparent;'
    'color:#111111;font-size:0.78rem;font-weight:700;font-family:Noto Sans KR,sans-serif;'
    'box-shadow:0 2px 6px rgba(0,0,0,0.10);transition:opacity 0.18s}')
_rows.append('.cat-html-btn:hover{opacity:0.82}')
_rows.append(f'.cat-html-btn{{background-image:url("{_cat_url}")}}')
_rows.append('</style>')
_rows.append('<div class="cat-html-grid">')
for _name in cat_names:
    _key = CATEGORIES[_name]['key']
    _form = (
        '<form action="" method="get" style="margin:0;padding:0">'
        f'<input type="hidden" name="cat" value="{_key}">'
        f'<button class="cat-html-btn" type="submit">{_name}</button>'
        '</form>'
    )
    _rows.append(_form)
_rows.append('</div>')
...
# query_params로 카테고리 클릭 감지
_params = st.query_params
if 'cat' in _params:
    _clicked_key = _params['cat']
    for _n, _info in CATEGORIES.items():
        if _info['key'] == _clicked_key:
            st.query_params.clear()
            handle_category(_n)


# query_params로 카테고리 클릭 감지 (handle_category 정의 후 실행)
_params = st.query_params
if 'cat' in _params:
    _clicked_key = _params['cat']
    for _n, _info in CATEGORIES.items():
